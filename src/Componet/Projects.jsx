  ...
  return (
    <div className='py-9 flex flex-col gap-4' id="proj">
        ...
        <ProjectCard theme={theme} name={"Promptopia"} desc={"A dedicated full stack website created to allow users to share their innovative ChatGPT prompts"} demo="https://promptopia-orpin.vercel.app/"/>
            ...
            <ProjectCard theme={theme} name={"WBT Services Ltd"} desc={"As a developer, I contributed to the creation of a website for WBT Services Ltd, a company specializing in industrial systems and solutions, showcasing products, providing information, and facilitating customer interactions."} demo="https://www.wbtservices.co.uk/" />
